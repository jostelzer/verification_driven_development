...
- Report Markdown: `tests/fixtures/reports/valid-report.md`
...
- Effect size versus baseline was 42ms at p95, well above the noise floor implied by the same benchmark harness.
